...
- **Boom Bots 3D** (`boom-bots/`): a first-person robot-factory blaster starring Vinny.

Each game is a single self-contained `index.html`. To add a new game, create a folder with its own `index.html` and link it from the top-level `index.html`.
